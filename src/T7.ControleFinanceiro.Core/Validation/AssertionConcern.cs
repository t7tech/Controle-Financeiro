...
namespace T7.ControleFinanceiro.Core.Validation
{
    public class AssertionConcern
    {
        ...
        public static void AssertArgumentIsGreaterThan(int value, int target, string message)
        {
            if (value < target)
            {
                throw new InvalidOperationException(message);
        ...
        public static void AssertArgumentIsGreaterThan(decimal value, int target, string message)
        {
            if (value <= target)
            {
                throw new InvalidOperationException(message);
        ...
        public static void AssertArgumentIsGreaterThan(double value, int target, string message)
        {
            if (value <= target)
            {
                throw new InvalidOperationException(message);
        ...
        public static void AssertArgumentIsSmallerThan(int value, int target, string message)
        {
            if (value > target)
            {
                throw new InvalidOperationException(message);
